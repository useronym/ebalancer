	...
	case vcl_lte(VCList1, VCList2) of
		...
		false -> %% VCList1 can be either greater than VCList2, or concurrent
			case vcl_lte(VCList2, VCList1) of
				...
				false ->
					{TA1, Node1} =< {TA2, Node2} %% The VCLists are concurrent -> TIEBREAK: Timestamp Approx. and then Node Name
			end
	end.
...
perf1() ->
	...
	Evcincrement2 = evc:increment(Node4_VC1),
	Node4_VC2 = evc:increment(Evcincrement2),
